...
function run_benchmark {
  ...
  echo "s LSM SQLITE INMEM CSV QL" > $BENCHMARK_RESULTS_FILENAME
  pr -W 128 -t -m  $LOGSLSMCLEAR $LOGSSQLCLEAR $LOGSINMCLEAR $LOGSCSVCLEAR $LOGSQLPCLEAR >> $BENCHMARK_RESULTS_FILENAME
